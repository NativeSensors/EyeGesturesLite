...
> ⚠️ **Notice:** EyeGestures Lite is being merged into the main repository and this repository will be archived soon.
>
> Development and all algorithms have moved to:  
> https://github.com/NativeSensors/EyeGestures
>
> EyeGestures Lite will remain accessible through the existing CDN script:
> `<script src="https://eyegestures.com/eyegestures.js"></script>`
>
> The source code will be maintained exclusively in the main repository going forward.
